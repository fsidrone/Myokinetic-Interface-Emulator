...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {sclk[0]}];  # "JA1"
set_property PACKAGE_PIN AA11 [get_ports {mosi[0]}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {miso[0]}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {cs[0]}];  # "JA4"
set_property PACKAGE_PIN AB11 [get_ports {sclk[1]}];  # "JA7"
set_property PACKAGE_PIN AB10 [get_ports {mosi[1]}];  # "JA8"
set_property PACKAGE_PIN AB9  [get_ports {miso[1]}];  # "JA9"
set_property PACKAGE_PIN AA8  [get_ports {cs[1]}];  # "JA10"


# ----------------------------------------------------------------------------
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W12 [get_ports {sclk[2]}];  # "JB1"
set_property PACKAGE_PIN W11 [get_ports {mosi[2]}];  # "JB2"
set_property PACKAGE_PIN V10 [get_ports {miso[2]}];  # "JB3"
set_property PACKAGE_PIN W8 [get_ports {cs[2]}];  # "JB4"
set_property PACKAGE_PIN V12 [get_ports {sclk[3]}];  # "JB7"
set_property PACKAGE_PIN W10 [get_ports {mosi[3]}];  # "JB8"
set_property PACKAGE_PIN V9 [get_ports {miso[3]}];  # "JB9"
set_property PACKAGE_PIN V8 [get_ports {cs[3]}];  # "JB10"
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN T22 [get_ports {ready[0]}];  # "LD0"
#set_property PACKAGE_PIN T21 [get_ports {ready[1]}];  # "LD1"
#set_property PACKAGE_PIN U22 [get_ports {ready[2]}];  # "LD2"
